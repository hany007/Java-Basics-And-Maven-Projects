...
<script src="<C:url value="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"/>" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<C:url value="Resourcescss/bootstrap.min.css"/>" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<C:url value="Resoucss/business-casual.css"/>" rel="stylesheet">
    ...
    <!--[if lt IE 9]>
        ...
        <script src="<Curl value="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"/>"></script>
    <![endif]-->
...
<body>
    ...
    <!-- jQuery -->
    <script src="<C:url value="Resourcesjs/jquery.js"/>"></script>
